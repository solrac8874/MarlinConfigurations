...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN P1_29       // Set a custom pin for the controller fan
...
#define X_HOME_BUMP_MM 5    // For delta all values must be the same
#define Y_HOME_BUMP_MM 5    // For delta all values must be the same
#define Z_HOME_BUMP_MM 5    // For delta all values must be the same
