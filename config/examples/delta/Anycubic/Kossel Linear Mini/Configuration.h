...
#define STRING_CONFIG_H_AUTHOR "(C. Walker, 20200718)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //E3D V6 Hotend w/ 24V Heater
  //PID Settings from PID autotune (M303 E0 S240):
  #define  DEFAULT_Kp 9.31
  #define  DEFAULT_Ki 0.48
  #define  DEFAULT_Kd 45.37
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //MK3 Heatbed (24V Round 3mm Aluminum w/ PEI Sheet)
  //PID settings from pidautotune (for ABS - M303 E-1 C8 S90):
  #define  DEFAULT_bedKp 493.40
  #define  DEFAULT_bedKi 84.54
  #define  DEFAULT_bedKd 1919.67
...
#define DELTA
  ...
  #define DELTA_HEIGHT 316.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 98.50              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_E0_STEPS_PER_UNIT }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 6000, 6000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 9000, 9000, 9000, 9000 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_YJERK DEFAULT_XJERK // XYZ Jerk must be the same for Delta
  #define DEFAULT_ZJERK DEFAULT_XJERK // XYZ Jerk must be the same for Delta
